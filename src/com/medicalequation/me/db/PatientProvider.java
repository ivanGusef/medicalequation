...
public class PatientProvider extends ContentProvider {
    ...
    static {
        ...
        sURIMatcher.addURI(AUTHORITY, PATIENTS_PATH + "/" + TREATMENT_FILTER + "/*", THERAPY_FILTERED_PATIENTS);
    ...
    private void checkColumns(String[] projection) {
        String[] available = {PatientTable.CN_ID, PatientTable.CN_FIO, PatientTable.CN_THERAPY, PatientTable.CN_MUTABLE_VALUES,
                PatientTable.CN_IMMUTABLE_VALUES, PatientTable.CN_RESULT_VALUES};
        if (projection != null) {
